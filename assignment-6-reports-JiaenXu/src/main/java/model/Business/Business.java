...
public class Business {
    ...
    // get Number of all customers in the business, and used when SupplierReport creates summaries.
    public int getAllCustomerNumber() {
        return customerdirectory.getCustomerList().size();
    }

    // SupplierReport
    public SupplierReport prepareSupplierReport() {
        supplierreport = suppliers.generateSupplierPerformanceReport(this.getAllCustomerNumber());
